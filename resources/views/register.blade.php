...
<body>
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Wikrama Canteen</a>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">Register at Canteen Wikrama</div>
            <div class="card-body">
                @if ($errors->any())
