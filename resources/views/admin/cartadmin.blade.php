...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-5">Data Keranjang</h1>
        <a href="#" type="button" class="btn btn-success mb-3">Keranjang</a>
        <form class="d-flex mb-3" role="search" action="/cartadmin" method="GET">
